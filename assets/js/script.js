...
const showClubs = matches => {
    if (matches.length > 0) {
        ...
        <div class="statcard col-8 statcard-primary statcard-${match.clubname.replace(/\s/g, '').replace('&', 'and').toLowerCase()} pl-2 py-2 pr-2 mb-1">
          <h2 class="statcard-number statcard-number-clubs">
            ${match.clubname}
          </h2>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-strike-rate-club', function() {
        ...
        console.log(clubHTMLName);
        let clubName = $(this).parent().prev().prev().children('h2').text().trim().split(' ').join('%20');
        console.log(clubName);

        function clubSummary(logo, age, goals) {
            return `<div class="col-12 statcard-img border-bottom-0 px-0"><img class="d-block mx-auto mt-4 mb-3" src="${goals.crestURL}" alt="${goals.clubname} club crest" height="auto" width="180"><div class="col-12 mb-4 px-0 border-top-0 statcard-img-name text-center"><h3>${goals.clubname}</h3></div></div><nav class="iconav mt-0 px-0 mb-0 col-12"><div class="iconav-slider row"><div class="col-12"><ul class="row nav nav-pills iconav-nav flex-md-column mx-0"><li class="nav-item px-0 col-4"><a class="nav-link active" href="#" title="Load Summary dashboard" data-toggle="tooltip" data-placement="right" data-container="body"><span class="icon iconav-icon icon-list"></span><small class="iconav-nav-label hidden-md-up">Summary</small></a></li><li class="nav-item px-0 col-4 ml-0"><a class="nav-link" href="#" title="Load StrikeRate dashboard" data-toggle="tooltip" data-placement="right" data-container="body"><span class="icon iconav-icon icon-circular-graph"></span><small class="iconav-nav-label hidden-md-up">StrikeRate</small></a></li><li class="nav-item px-0 col-4 ml-0"><a class="nav-link" href="#" title="Load StrikeValue dashboard" data-toggle="tooltip" data-placement="right" data-container="body"><span class="icon iconav-icon icon-line-graph"></span><small class="iconav-nav-label hidden-md-up">StrikeValue</small></a></li></ul></div></div></nav><div class="col-12 px-0 statcard-body-wrapper"><div class="row statcard-body-row mx-0"><div class="col-12 border-top-0 statcard-body"><div class="row statcard-row statcard p-3"><div class="col-4 statcard-col text-center"><h4 class="statcard-stat statcard-number">${age}</h4><span class="statcard-desc">Age</span></div><div class="col-4 statcard-col"></div><div class="col-4 statcard-col text-center"><h4 class="statcard-stat statcard-number">${age}</h4><span class="statcard-desc">Number</span></div></div><div class="row statcard-row statcard px-3"><div class="col-4 statcard-col text-center"></div><div class="col-4 px-0 statcard-col text-center"><span class="icon icon-sports-club"></span></div><div class="col-4 statcard-col text-center"></div></div><div class="row statcard-row statcard p-3"><div class="col-4 statcard-col text-center"><h4 class="statcard-stat statcard-number">${goals.goals}</h4><span class="statcard-desc">Goals</span></div><div class="col-4 statcard-col"></div><div class="col-4 statcard-col text-center"><h4 class="statcard-stat statcard-number" id="statcard-value-stat">${goals.goals}m</h4><span class="statcard-desc">Value</span></div></div></div></div></div>`
        }
        ...
        var getClubInfo = function() {
            ...
            $.ajax(getClubID).done(function(response) {
                ...
                console.log(getClubProfile.url);
                $.when(
                    $.ajax(get_ClubLogo),
                    $.ajax(getClubProfile),
                    $.ajax('assets/data/clubdata.json')
                ).then(
                    function(responseLogo, responseClubProfile, responseClubGoals) {
                        ...
                        $(clubMatchList).html(clubSummary(clubLogo, avgAge, clubGoals));
