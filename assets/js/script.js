...
const showScorers = matches => {
    if (matches.length > 0) {
      ...
      <div class="statcard col-9 statcard-primary statcard-${match.club.replace(/\s/g, '').replace('&', 'and').toLowerCase()} pl-2 py-2 pr-2 p-lg-3 mb-1">
...
const showClubs = matches => {
    if (matches.length > 0) {
        ...
        <div class="statcard col-8 statcard-primary statcard-${match.clubname.replace(/\s/g, '').replace('&', 'and').toLowerCase()} pl-2 py-2 pr-2 p-lg-3 mb-1">
