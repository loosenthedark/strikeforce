$(document).ready(function () {
  ...
  const dropdownClubs = $("#dropdown-clubs");
  const dropdownClubz = $("#dropdown-clubz");
  ...
  const mainNavLinks = $("#nav-main a");
  const scorersDashboardsMainNavLink = $("#scorers-dashboards-menu-nav-link");
  const clubsDashboardsMainNavLink = $("#clubs-dashboards-menu-nav-link");

  if (window.location.href.indexOf("#player-match-list") > -1) {
    mainNavLinks.removeClass("active");
    scorersDashboardsMainNavLink.addClass("active");
    pillsTabLinks.removeClass("active");
    pillsScorersTabLink.addClass("active");
    clubsPane.removeClass("active");
    scorersPane.addClass("active");
  } else if (window.location.href.indexOf("#club-match-list") > -1) {
    mainNavLinks.removeClass("active");
    clubsDashboardsMainNavLink.addClass("active");
    pillsTabLinks.removeClass("active");
  ...
  pillsScorersTabLink.click(function () {
    mainNavLinks.removeClass("active");
    scorersDashboardsMainNavLink.addClass("active");
  });

  clubsDashboardsMainNavLink.click(function () {
    location.assign("#club-match-list");
    location.reload();
  });

  scorersDashboardsMainNavLink.click(function () {
    location.assign("#player-match-list");
    location.reload();
  });
  ...
  $.get("assets/data/playerdata.json", function (data) {
    ...
    var updateSelectScorerBox = function (scorers) {
      selectScorerBoxContent =
        '<h6 class="pl-3 dropdown-header">Choose a scorer</h6>';

      for (let i = 0; i < scorers.length; i++) {
        selectScorerBoxContent +=
          '<a class="dropdown-item pl-3" href="#">' + scorers[i] + "</a>";
      }
  ...
  $.get("assets/data/clubdata.json", function (data) {
    var showChosenClub = function (club, clubAPI) {
      let clubName = club.split(" ").join("%20");
          ...
          $.when(
            ...
            function (
              ...
              for (let i = 0; i < responseClubGoals[0].length; i++) {
                if (`${club}` === `${responseClubGoals[0][i].clubname}`) {
