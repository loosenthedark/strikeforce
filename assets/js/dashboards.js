$(document).ready(function() {
    ...
    $.get("assets/data/playerdata.json", function(data) {
        ...
        var updateSelectScorerBox = function(scorers) {
            selectScorerBoxContent = '<h6 class="pl-3 dropdown-header">Choose a scorer</h6>';

            for (let i = 0; i < scorers.length; i++) {

                selectScorerBoxContent += '<a class="dropdown-item pl-3" href="#">' + scorers[i] + '</a>';
            }
